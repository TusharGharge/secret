...
import 'package:user/models/question_model.dart';
import 'package:user/motion/home.dart';
import 'package:user/services/database.dart';
import 'package:user/views/floatingContainer.dart';

import 'package:user/views/results.dart';
import 'package:user/views/videodemo.dart';
import 'package:user/widget/widget.dart';
import 'package:user/widgets/quiz_play_widgets.dart';

class QuizPlay extends StatefulWidget {
  static const idscreen = '/Quizplay';
  final String quizId;
                          ...
                          child: Column(
                            children: [
                              ...
                              questionSnaphot.documents == null
                                  ...
                                  : ListView.builder(
                                      itemCount:
                                          questionSnaphot.documents.length,
                                      shrinkWrap: true,
